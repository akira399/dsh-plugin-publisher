...
window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    var DICT_ZH = {
      ...
      tokenHint: "用于 GitHub 推送/建仓。保存后自动写入系统 Git 凭据管理器，且不会回显。留空表示保持现有值。",
      ...
      dirtyHint: "有未保存的修改",
      failed: "保存失败，请重试",
      saved: "已保存。技能启用状态即时生效；GitHub Token 已同步到系统凭据管理器。",
    ...
    var DICT_EN = {
      ...
      enabledOff: "Disabled",
      tokenLabel: "GitHub Token",
      tokenHint: "Used for GitHub push/repo creation. Saved into the system Git credential manager and never echoed. Leave blank to keep the current value.",
      ...
      saved: "Saved. Skill state takes effect immediately; the GitHub token was synced to the system credential manager.",
